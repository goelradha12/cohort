...
const SubmissionResult = ({ submission }) => {
  ...
  const inputArr = submission.submission.stdin.split('\n') || "[]";
  // Calculate averages
  const avgMemory =
    memoryArr
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="card bg-base-200 shadow-sm">
            <div className="card-body p-4">
              ...
              <div
                className={`text-lg font-bold ${submission.submission.status === "ACCEPTED"
                    ? "text-success"
                    : "text-error"
                  }`}
              >
        ...
        <div className="card-body">
          ...
          <div className="overflow-x-auto">
            <table className="table table-zebra w-full">
              ...
              <tbody>
                {submission.TestCaseResult.map((testCase, i) => (
                  <tr key={testCase.id}>
                    <td>
                      {testCase.passed ? (
                    ...
                    <td className="font-mono">{inputArr[i]}</td>
